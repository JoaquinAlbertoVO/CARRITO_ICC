                        ...
                        <div class="courses-one__single style2 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                            <div class="courses-one__single-content">
                                ...
                                <div class="course-details__content-list">
                                    <h3 class="course-details__curriculum-single-title" style="font-size: 25px; text-align: center; margin: 5px 0 0 0;">TEMARIO</h3>
                                </div><br>
                                <div class="course-details__content-list">
                                    <h3 class="course-details__curriculum-single-title">Objetivo:</h3>
                                    <ul class="list-unstyled">
                                        <li>
                                            <div class="icon">
                                        ...
                                        <li>
                                            ...
                                            <div class="text">
                                                <p>Estudiar las normas nacionales e internacionales vigentes.</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                ...
                                <div class="course-details__content-list">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            ...
                                            <div class="text">
                                                <p>Soluciones Schneider Electric.</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                            ...
                                            <div class="text">
                                                <p>Soluciones para instalaciones ya existentes.</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="icon">
                                    ...
                                    <div class="col-xl-7 col-lg-7 col-md-7">
                                        <div class="course-details__progress clearfix">
                                            <div class="course-details__progress-item">
                                                <p class="course-details__progress-text">Avanzado</p>
                                            ...
                                            <div class="course-details__progress-item">
                                                <p class="course-details__progress-text">Intermedio</p>
                                                <div class="course-details__progress-bar">
                                    ...
                                    <form action="assets/inc/sendemail.php" class="comment-one__form contact-form-validated" novalidate="novalidate">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12">
                                                <a href="https://wa.link/zw6o1w" target="_black" class="thm-btn comment-form__btn">COMPRA YA</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="course-details__sidebar">
                        <div class="course-details__price wow fadeInUp animated" data-wow-delay="0.1s">
                            <h2 class="course-details__price-amount">S/99.90<span><del>S/109.90</del></span></h2>
                            <div class="course-details__price-btn">
                                <a href="https://wa.link/zw6o1w" target="_black" class="thm-btn">compra este curso</a>
                            </div>
                        </div>
                            ...
                            <ul class="course-details__new-courses-list list-unstyled">
                                <li class="course-details__new-courses-list-item">
                                    ...
                                    <div class="course-details__new-courses-list-item-content">
                                        ...
                                        <p class="course-details__new-courses-price">S/99.90</p>
                                    </div>
                                </li>
