                            ...
                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Programación básica P.L.C </strong>
                                        ...
                                        <div class="tab">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid1" onclick="changeVid(this.id)">INTRODUCCIÓN: Programación Básica de PLC.</a>
                                                    </div>
                                                    <div class="media-right">
                                            ...
                                            <div class="tab-content1">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a type="button" href="#player1" id="vid2" onclick="changeVid(this.id)">SOFTWARE DE PROGRAMACIÓN.</a>
                                                    </div>
                                                    <div class="media-right">
                                                        <small class="text-muted">3:33</small>
                                                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                <!--        <div class="card-body" id="course_content">-->
                                <!--            <a href='https://drive.google.com/uc?export=download&id=1xImLcOxFLL_aKRjZJAE3PpqchbWUH4At' target='_blank'><button type='button' class='btn btn-success'>Programación Básica PLC</button></a>-->
                                <!--        </div>-->
                                <!--    </div>-->
                                <!--</div>-->
