    ...
    <div class="container page__container mt-5 mb-5">
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="video-container mb-2" style="background: #000; border-radius: 8px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe id="player1" class="embed-responsive-item" src="<?= $primer_video ?>" allowfullscreen></iframe>
                    </div>
                </div>
                <div class="text-right mb-4">
                    <form action="<?= BASE_URL ?>aula/marcar_progreso" method="POST" id="formCompletado" style="display: none;">
                        <input type="hidden" name="id_curso" value="<?= $curso['id_curso'] ?>">
                        <input type="hidden" name="id_video" id="inputVideoId" value="">
                        <button type="submit" class="btn btn-success" style="border-radius: 20px; font-weight: bold;">
                        ...
                        <li class="mt-4 text-center pb-2 border-0">
                            <?php if($porcentaje_progreso == 100): ?>
                                <?php if($estado_certificado == 0): ?>
                                    <form action="<?= BASE_URL ?>aula/solicitar_certificado" method="POST">
                                        <input type="hidden" name="id_curso" value="<?= $curso['id_curso'] ?>">
                                        <button type="submit" class="btn btn-success btn-block" style="border-radius: 20px; font-weight: bold;">
...
<script type="text/javascript">
    ...
    function updateCompletadoUI(videoId) {
        if(videosCompletados.includes(String(videoId)) || videosCompletados.includes(Number(videoId))) {
            document.getElementById('formCompletado').style.display = 'none';
            document.getElementById('txtCompletado').style.display = 'inline-block';
        } else {
            document.getElementById('formCompletado').style.display = 'inline-block';
