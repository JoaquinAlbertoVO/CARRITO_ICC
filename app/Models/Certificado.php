...
class Certificado {
    ...
    public function generarImagenCertificado($alumno, $dni, $curso, $horas, $fecha_emision, $categoria) {
        ...
        // 1. Nombres del alumno (Fuente Serif, más grande)
        $bbox = imagettfbbox(52, 0, $font_serif, mb_strtoupper($alumno, 'UTF-8'));
        $x_nombre = (int)(1130 - ($bbox[2] / 2)); // Centrado sobre la linea
        imagettftext($imagen, 52, 0, $x_nombre, 465, $color_nombre, $font_serif, mb_strtoupper($alumno, 'UTF-8'));
        ...
        imagettftext($imagen, 24, 0, (int)(1130 - ($b_p2[2]/2)), 740, $color_curso_bold, $font_bold, $parrafo2);
