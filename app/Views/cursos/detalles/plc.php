                    ...
                    <div class="course-details__content">
                        ...
                        <div class="courses-one__single style2 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                            <div class="courses-one__single-img">
                                <img src="<?= BASE_URL ?>assets/images/resources/programacio_plc.png" alt=""/>
                            ...
                            <div class="courses-one__single-content">
                                ...
                                <h4 class="courses-one__single-content-title">ProgramaciÃ³n bÃ¡sica de PLC</h4>
                                    ...
                                    <form action="assets/inc/sendemail.php" class="comment-one__form contact-form-validated" novalidate="novalidate">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12">
                                                <a href="https://wa.link/ri06nc" target="_black" class="thm-btn comment-form__btn">InscrÃ­bete AquÃ­</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
