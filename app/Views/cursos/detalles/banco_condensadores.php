<!--Page Header Start-->
                    ...
                    <div class="course-details__content">
                        ...
                        <div class="courses-one__single style2 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                            <div class="courses-one__single-img">
                                <div style="background-color: var(--mo-surface); border: 2px dashed var(--mo-accent); border-top-left-radius: 8px; border-top-right-radius: 8px; width: 100%; height: 350px; display: flex; align-items: center; justify-content: center; text-align: center; padding: 20px;"><img src="<?= BASE_URL ?>assets/images/Banco_de_Condensadores.jpeg" style="width:100%; height:100%; object-fit:cover; border-radius:8px;"></div>
    ...
    <span style="color: var(--mo-accent); font-family: var(--mo-font-heading); font-size: 9px; line-height: 1;">FOTO<br>50x50</span>
                                ...
                                <h6 class="courses-one__single-content-name">Johan Paredes <span>Actualizado recientemente 20 junio, 2021</span></h6>
                                <h4 class="courses-one__single-content-title">Banco de Condensadores</h4>
                                    ...
                                    <form action="assets/inc/sendemail.php" class="comment-one__form contact-form-validated" novalidate="novalidate">
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12">
                                                <a href="https://wa.link/fa2jtr" target="_black" class="thm-btn comment-form__btn">Inscríbete Aquí</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div class="course-details__sidebar">
                        <div class="course-details__price wow fadeInUp animated" data-wow-delay="0.1s">
                            ...
                            <div class="course-details__price-btn">
                                <a href="https://wa.link/fa2jtr" target="_black" class="thm-btn">compra este curso</a>
                            </div>
                        </div>
                        ...
                        <div class="course-details__new-courses wow fadeInUp animated" data-wow-delay="0.5s">
                            ...
                            <ul class="course-details__new-courses-list list-unstyled">
                                ...
                                <li class="course-details__new-courses-list-item">
                                    ...
                                    <div class="course-details__new-courses-list-item-content">
                                        <h4 class="course-details__new-courses-list-item-content-title"><a href="<?= BASE_URL ?>cursos/detalle/plc">Programación Básica de PLC</a></h4>
                                        <div class="course-details__new-courses-rateing-box">
                                            <ul class="list-unstyled">
                                                <li><i class="fas fa-star"></i></li>
                                                <li><i class="fas fa-star"></i></li>
