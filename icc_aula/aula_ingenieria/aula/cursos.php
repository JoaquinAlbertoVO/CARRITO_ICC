        ...
        <div class="mdk-header-layout__content page">
            ...
            <div class="container page__container mt-4 mb-4">
                <div class="row" style="height: 400px;">
                    <div class="col-md-4">
                        <div data-perfect-scrollbar style="position: relative; height:200px;">

                            <div class="card clear-shadow border">
                                <div class="card-body ">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <strong>Costo y Presupuesto </strong>
                                        <small class="text-muted">3h 25min</small>
                                    </div>
                                    <div>
                                        <span class="mr-2">
                            ...
                            <ul class="list-group list-group-fit">
                                <li class="list-group-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <a type="button" id="vid1" onclick="changeVid(this.id)">Sesión 1</a>
                                        </div>
                                ...
                                <li class="list-group-item active">
                                    <div class="media">
                                        <div class="media-left mr-1">2.</div>
                                        <div class="media-body">
                                            <a type="button" class="text-white" id="vid2" onclick="changeVid(this.id)">Asset Pipeline</a>
                                        </div>
                                        <div class="media-right">
                                            <small>18:43</small>
                                        </div>
                                ...
                                <li class="list-group-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <a href="#">Layout Structure</a>
                                        </div>
                                        <div class="media-right">
                                            <small class="text-muted">4:23</small>
                                        </div>
                                    </div>
                                </li>
                                <li class="list-group-item">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="embed-responsive embed-responsive-16by9 mb-4" style="max-height:400px; background: #000;">
                            <iframe id="player1" class="embed-responsive-item" src="https://www.youtube.com/embed/bjDOgmU-4JY" allowfullscreen=""></iframe>
                        </div>
            ...
            <script type="text/javascript">
                ...
                {   
                    var newVid = "https://www.youtube.com/embed/bjDOgmU-4JY";
                    if (clicked_id === 'vid1') {
                        newVid = 'https://www.youtube.com/embed/bjDOgmU-4JY';
                    }
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            <div class="card-header card-header-tabs-basic nav border-top" role="tablist">
                                <a href="#overview" class="active" data-toggle="tab" role="tab" aria-controls="overview" aria-selected="true">Temario</a>
                                <a href="#comments" data-toggle="tab" role="tab" aria-selected="false">Archivos</a>
                                <!--<a href="#assets" data-toggle="tab" role="tab" aria-selected="false">Assets</a>-->
                            </div>
                            <div class="tab-content">
                                <div class="tab-pane active" id="overview">
                                    <div class="card-body" id="course_content">
                                        <p>Proximamente se estaran cargando los temarios en esta seccion. </p>
                                ...
                                <div class="tab-pane" id="comments">
                                    <div class="tab-pane active" id="overview"><br>
                                        <h4 style="text-align: center;">Archivos Descargables</h4>
                                        <div class="card-body" id="course_content">
                                            <a href='archivos/APU - El Maxi - Subestación San Antonio.xlsx' target='_blank'><button type='button' class='btn btn-success'>APU - El Maxi - Subestación San Antonio</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='archivos/CURSO COSTOS Y PRESUPUESTOS.pptx' target='_blank'><button type='button' class='btn btn-success'>CURSO COSTOS Y PRESUPUESTOS</button></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane active" id="overview">
                                        <div class="card-body" id="course_content">
                                            <a href='archivos/EM-00063-22 SED SAN ANTONIO - EL MAXI.docx' target='_blank'><button type='button' class='btn btn-success'>EM-00063-22 SED SAN ANTONIO - EL MAXI</button></a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-header card-header-large bg-light d-flex align-items-center">
                                <div class="flex">
                                    <h4 class="card-header__title">Mi progreso</h4>
                                    <div class="card-subtitle text-muted">Progreso actual de la sesión</div>
                                </div>
                                <div class="ml-auto">
                                    <a href="#" class="btn btn-light text-muted"><i class="material-icons icon-16pt">check_circle</i> Completado</a>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header bg-light">
                                <h4 class="card-header__title">Logros</h4>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                Tener más de 12 años de exp. Adrian es uno de los principales diseñadores de interfaz de usuario de nuestro equipo.
                            </div>
                        </div>
                    </div>
                </div>
