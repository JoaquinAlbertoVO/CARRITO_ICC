<?php $base_path = "../";  
include '../cursos/head.php'; 
include '../cursos/header.php';
?>

    <!--Page Header Start-->
    <section class="page-header clearfix" style="background-image: url(assets/images/backgrounds/icc_capacitacion.png);">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
    ...
    <!--Courses One End-->
<?php  
include '../cursos/footer.php';
include '../cursos/mobile.php';
include '../cursos/script.php';
?>